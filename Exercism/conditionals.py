...
def reactor_efficiency(voltage, current, theoretical_max_power):
    """Assess the reactor efficiency zone.
    ...
    if percent_value >= 80:
        return "green"
    elif 80 > percent_value >= 60:
        return "orange"
    elif 60 > percent_value >= 30:
        return  "red"
    else:
        return "black"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    neu  = temperature * neutrons_produced_per_second
    if neu < (90/100 * threshold):
        return "LOW"
    elif (neu + (10 / 100 * threshold)) >= neu >= (neu - (10 / 100 * threshold)):
        return "NORMAL"
    return "DANGER"
